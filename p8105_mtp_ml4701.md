...
2.  From the following plot, no clear trend is seen either accross `age`
    and `sex` groups, or between `eop_size_mm` and `fhp_size_mm`, so EOP
    size may not be associated with FHP size, gender or age.
...
|:----------------|:------------|:--------------|
| Word count      | 502         | 432           |
| Character count | 2924        | 2924          |
| Sentence count  | 44          | Not available |
| Reading time    | 2.5 minutes | 2.2 minutes   |
